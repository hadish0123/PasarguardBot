...
async def render(event):
 ...
 me=await event.client.get_me();username=getattr(me,"username",None);buttons=[]
 ...
 text+=f"\n\n🔗 لینک دعوت آماده است؛ با آن کاربر جدید مستقیماً به ربات شما وارد می‌شود." if username else "\n\n⚠️ نام کاربری عمومی ربات تنظیم نشده است."
