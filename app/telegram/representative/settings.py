  ...
  async with tenant_dispatch(tenant_id):
   ...
   try:
    if field=="force_join_channel_id":
     ...
     await validate_channel_admin(bot_token,channel_id)
    ...
    return await event.respond("❌ بررسی دسترسی ربات به کانال انجام نشد. دوباره تلاش کنید.")
