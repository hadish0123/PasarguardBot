...
PAGES: tuple[PageSpec, ...] = (
    ...
    PageSpec("A-03", Area.ADMIN, "Representative User Management", "Search, inspect, block or unblock customers, and safely adjust customer wallet balance.", ("A-01 users", "rep:users"), ("list", "search", "view", "block", "unblock", "add_balance", "subtract_balance", "cancel", "back"), ("empty", "listing", "searching", "detail", "blocked", "active", "balance_input", "balance_updated", "error"), "active representative owner", "current tenant users and tenant wallet ledger", ("SQLAlchemy", "RepresentativeUserService", "UserBalanceLog", "tenant runtime")),
    PageSpec("A-04", Area.ADMIN, "Sales and Order Management", "Review tenant orders and move them through pending, paid, fulfilled, or cancelled states.", ("A-01 orders", "rep:rep.orders"), ("list", "view", "confirm_payment", "fulfill", "cancel", "back"), ("empty", "listing", "detail", "pending", "paid", "fulfilled", "cancelled", "error"), "active representative owner", "current tenant orders", ("SQLAlchemy", "OrderService", "PlanService", "tenant runtime")),
